...
def create_pyraminx():
    ...
    gby_octa_ay.description = 'three bells hung from the corners. A chest suspended in a bell in the center of the room. There is a door, but it''s blocked by a Wall of Force'
